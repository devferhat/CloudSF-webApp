...
public class FilterAppType implements Serializable {
    ...
    @JoinColumn(name = "SM_Code", referencedColumnName = "SM_Code", nullable = false, insertable = false, updatable = false)
    ...
    @JoinColumn(name = "App_Code", referencedColumnName = "APP_Code", nullable = false, insertable = false, updatable = false)
    @ManyToOne(optional = false)
